    ...
    class MaintenanceWindowProperty:
        def __init__(
            ...
            *,
            ...
            '''
            :param type: The type of maintenance window.
            :param apply_time_of: The desired time zone maintenance window.
            :param days_of_the_week: The date of maintenance window.
            :param end_time_hour: 
            :param end_time_minute: 
